...
/**
 * Authentication for Generic OAuth2.
 * Note: if named Oauth2AuthenticationProvider, it get's autowired.
 */
@Component
public class GPTOauth2AuthenticationProvider implements AuthenticationProvider {
  
  private static final Logger LOGGER = LoggerFactory.getLogger(GPTOauth2AuthenticationProvider.class);
...
//    return authorizeUrl.substring(0,authorizeUrl.indexOf("/sharing/rest/oauth2/"))+"/sharing/rest";
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    LOGGER.debug("CILogonAuthenticationProvider::authenticate");
