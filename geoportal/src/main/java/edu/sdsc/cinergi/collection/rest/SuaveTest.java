...
public class SuaveTest {
    ...
    public static String writeFile(String[] jsons) {
        try {
            ...
            CSVWriter csvw = new CSVWriter(new FileWriter(new File("suavetemp.csv")));
            ...
            for (int i = 0; i < jarr.length; i++) {
                ...
                if (md.has("envelope_geo")){
                   ...
                   if (temparr.get(0) instanceof JSONArray) {
                    ...
                    alld[i][4] = Double.toString((double)temparr.get(1));
                    alld[i][5] = Double.toString((double)temparr.get(0));
                }
