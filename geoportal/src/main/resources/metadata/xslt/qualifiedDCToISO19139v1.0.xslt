 ...
 *  Unless required by applicable law or agreed to in writing, software distributed under the License is 
        ...
        <gmd:contact>
            <gmd:CI_ResponsibleParty>
                <gmd:organisationName>
                    <gco:CharacterString>EarthCube Data Discovery Studio</gco:CharacterString>
                </gmd:organisationName>
                <gmd:contactInfo>
                    <gmd:CI_Contact>
                        <gmd:address>
                            <gmd:CI_Address>
                                <gmd:electronicMailAddress>
                                    ...
                                    <gco:CharacterString>
                                        <xsl:value-of select="'datadiscoverystudio@gmail.com'"/>
                                    </gco:CharacterString>
                                </gmd:electronicMailAddress>
                            </gmd:CI_Address>
                        </gmd:address>
    ...
    <xsl:variable name="maintenanceContactName" select="string('Data Discovery Studio metadata curator')"/>
